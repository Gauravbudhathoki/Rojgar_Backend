...
const user_services_1 = require("../../services/admin/user.services");
const admin_user_services_1 = require("../../services/admin/admin.user.services");
const adminService = new admin_user_services_1.AdminService();
    ...
    async getAllAdmins(req, res, next) {
        try {
            ...
            if (!Array.isArray(admins))
                return res.json({ success: true, message: "No admins found", data: [] });
